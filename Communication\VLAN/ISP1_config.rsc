...
# 2026-09-25 14:51:42 by RouterOS 7.21.5
# system id = MixTA0QmvkO
#
/interface ethernet
...
/ip pool
add name=LAN-pool ranges=10.10.10.2-10.10.10.20
/ip address
...
add address=10.10.10.0/24 dns-server=10.10.10.2 gateway=10.10.10.2
/ip route
add dst-address=20.6.5.0/30 gateway=10.1.2.2
/system identity
set name=ISP1
